"""
Minimal working tests for ScannersController
"""
...
class TestScannersController(ControllerTestBase):
    """Minimal test cases for ScannersController class."""
    
    @pytest.fixture
    def controller(self):
        """Create ScannersController instance for testing."""
    ...
    def test_controller_basic_functionality(self, mock_get_user, controller):
        ...
        assert controller.__class__.__name__ == 'ScannersController'
