"""
Minimal working tests for ScannerTypeController
"""
...
class TestScannerTypeController(ControllerTestBase):
    """Minimal test cases for ScannerTypeController class."""
    
    @pytest.fixture
    def controller(self):
        """Create ScannerTypeController instance for testing."""
        return ScannerTypeController()
    ...
    def test_controller_basic_functionality(self, mock_get_user, controller):
        ...
        assert controller.__class__.__name__ == 'ScannerTypeController'
